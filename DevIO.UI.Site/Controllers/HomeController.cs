...
namespace DevIO.UI.Site.Controllers
{
    ...
    {
        public OperacaoService OperacaoService { get; } //Injeção de dependência
        public OperacaoService OperacaoService2 { get; } //Injeção de dependência
        ...
        public string Index()
        {
            //Concatenação dos dados da primeira e segunda instância
            return
